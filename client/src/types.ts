...
export interface Turn { role: 'user' | 'ai'; text: string; translation?: string; score?: number; accuracy?: number; fluency?: number; integrity?: number; weakPhones?: string[]; phoneScores?: Array<{ phoneme: string; score: number }>; tips?: string; tryAgain?: string; audio?: string }
